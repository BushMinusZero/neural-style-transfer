...
def show_images(style_img, content_img):
...
def main():
    ...
    style_image_path = "data/images/neural-style/styles/sticks_of_butter.jpg"
    content_image_path = "data/images/neural-style/butter.jpg"
    output_dir = "output"
    ...
    image = unloader(output.data[0])
    output_filepath = os.path.join(output_dir, "_".join(
